...
import { ServerCredentialCreationOptions, ServerCredentialRequestOptions, WebAuthnApi, WebAuthnError } from '@supabase/auth-js/src/lib/webauthn';
import type { RegistrationResponseJSON, AuthenticationResponseJSON, ServerCredentialResponse } from '@supabase/auth-js/src/lib/webauthn';
